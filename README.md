...
2. [ OPTIONAL STEP ] Getting Data Files ( for Visium Mouse Brain Data ) 
                                                                                                                                                                        
    This step is for pulling in the spaceranger outputs into the system for the pipeline to recognize the correct file architecture. You can modify the the /data directory to analyze your own data instead of Mouse Brain.
                                                                              
   The wget.sh is configured to pull the Spaceranger output data files into:
               `/visium/data/Visium_FFPE_Mouse_Brain/outs`
   and the allen_cortex.rds is to be put in:
                `/visium/data`
